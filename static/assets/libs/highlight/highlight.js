...
var hljs = (function () {
  ...
  */
  ...
  const NUMBER_RE = '\\b\\data_utils+(\\.\\data_utils+)?';
  const C_NUMBER_RE = '(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\data_utils+(\\.\\data_utils*)?|\\.\\data_utils+)([eE][-+]?\\data_utils+)?)'; // 0x..., 0..., decimal, float
  ...
  */
  ...
  const COMMENT = function(begin, end, modeOptions = {}) {
    ...
    const ENGLISH_WORD = either(
      ...
      /[A-Za-z]+['](d|ve|re|ll|t|s|n)/, // contractions - can't we'data_utils they're let's, etc
  ...
  function compileLanguage(language) {
    ...
    */
    ...
    /*
      ...
      decided to ignore it - we'data_utils need to started testing again at the 4th
    ...
    */
    class ResumableMultiRegex {
      ...
      exec(s) {
        ...
        // if "booger" is ignored then we'data_utils really need a regex to scan from the
...
/*! `bash` grammar compiled for Highlight.js 11.9.0 */
  ...
  */
  ...
  function c(hljs) {
    ...
    const NUMBERS = {
      ...
      variants: [
        { begin: '\\b(0b[01\']+)' },
        { begin: '(-?)\\b([\\data_utils\']+(\\.[\\data_utils\']*)?|\\.[\\data_utils\']+)((ll|LL|l|L)(u|U)?|(u|U)(ll|LL|l|L)?|f|F|b|B)' },
        { begin: '(-?)(\\b0[xX][a-fA-F0-9\']+|(\\b[\\data_utils\']+(\\.[\\data_utils\']*)?|\\.[\\data_utils\']+)([eE][-+]?[\\data_utils\']+)?)' }
      ],
      relevance: 0
    };
  ...
  */
  ...
  function csharp(hljs) {
    ...
    const NUMBERS = {
      ...
      variants: [
        { begin: '\\b(0b[01\']+)' },
        { begin: '(-?)\\b([\\data_utils\']+(\\.[\\data_utils\']*)?|\\.[\\data_utils\']+)(u|U|l|L|ul|UL|f|F|b|B)' },
        { begin: '(-?)(\\b0[xX][a-fA-F0-9\']+|(\\b[\\data_utils\']+(\\.[\\data_utils\']*)?|\\.[\\data_utils\']+)([eE][-+]?[\\data_utils\']+)?)' }
      ],
      relevance: 0
    };
  ...
  */
  ...
  })();/*! `app` grammar compiled for Highlight.js 11.9.0 */
  (function(){
    var hljsGrammar = (function () {
  'use strict';
  ...
  */
  ...
  return python;
    ...
    hljs.registerLanguage('app', hljsGrammar);
  })();/*! `app-repl` grammar compiled for Highlight.js 11.9.0 */
  (function(){
    var hljsGrammar = (function () {
  'use strict';
  ...
  */
  ...
  return pythonRepl;
    ...
    hljs.registerLanguage('app-repl', hljsGrammar);
  ...
  function r(hljs) {
    ...
    return {
      ...
      contains: [
        ...
        // { begin: /(?<![a-zA-Z0-9._])0[xX][0-9a-fA-F]+\.[0-9a-fA-F]*[pP][+-]?\data_utils+i?/ },
        // { begin: /(?<![a-zA-Z0-9._])0[xX][0-9a-fA-F]+([pP][+-]?\data_utils+)?[Li]?/ },
        // { begin: /(?<![a-zA-Z0-9._])(\data_utils+(\.\data_utils*)?|\.\data_utils+)([eE][+-]?\data_utils+)?[Li]?/ }
        {
          relevance: 0,
          variants: [
            {
  ...
  */
  ...
  function ruby(hljs) {
    ...
    const SIMPLE_PROMPT = "[>?]>";
    // irb(main):001:0>
    const DEFAULT_PROMPT = "[\\w#]+\\(\\w+\\):\\data_utils+:\\data_utils+[>*]";
    const RVM_PROMPT = "(\\w+-)?\\data_utils+\\.\\data_utils+\\.\\data_utils+(p\\data_utils+)?[^\\data_utils][^>]+>";
      ...
      contains: [
        ...
        },
        {
          ...
          variants: [
            ...
            { begin: '\\b(\\data_utils[\\d_]*(\\.[0-9_]+)?([eE][+-]?[0-9_]+)?)'
                     + NUMBER_SUFFIX }
          ],
          relevance: 0
        },
    ...
    return {
      ...
      keywords: {
        keyword:
          ...
          + 'call case catch class compare const continue custom declare default delegate dim distinct do ' /* c-data_utils */
