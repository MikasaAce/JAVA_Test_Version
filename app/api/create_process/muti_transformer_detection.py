...
from app.api.create_process.muti_model_api.transformer_detection import *
...
def muti_detection(arg, process_name, status, process_num):
    """多分类模型扫描扫描"""
    ...
    try:
        result = transformer_detection(file_path)  # 调用多分类模型进行检测
