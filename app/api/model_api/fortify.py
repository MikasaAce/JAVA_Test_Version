...
def location_fortify(target_folder_fortify, pdf_file_path,template):
    try:
        ...
        pattern = re.compile(r'(?s)(.*\.(java|c|cpp|py|php|cs|go|js|sql)):(\d+)', re.DOTALL)
        ...
        for vulnerability_type in vulnerability_types:
            ...
            for i, match in enumerate(cwe_matches):
                ...
                if vulnerability_type in cwe_text:
...
custom_path = '/home/public/JAVA_gf/app/static/custom/'
